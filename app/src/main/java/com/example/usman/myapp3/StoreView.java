...
public class StoreView extends View{
    ...
    private final float TAB_TEXT_LIMIT = 82*scale;
    float tabTextX,cx,cy;
    int tabIndex = 1;
    ...
    public StoreView(Context context) {
        ...
        coinMatrix.setTranslate(Assets.coin.getWidth()/2,Assets.coin.getHeight()/2);
        ...
        //rect.set(Assets.storeTab.getWidth()+(10*scale),sH*0.27f,);
    ...
    protected void onDraw(Canvas canvas){
        ...
        canvas.drawText("upgrades",tabTextX,sH*0.44f+(Assets.storeTab.getHeight()/2)+white.getTextSize()/3,white);
        canvas.drawBitmap(Assets.storeTab,0,sH*0.61f,null);
        canvas.drawText("items",tabTextX,sH*0.61f+(Assets.storeTab.getHeight()/2)+white.getTextSize()/3,white);
        coinMatrix.postTranslate(cx,cy);
